...
export const availableTasks = [
  ...
  { label: "一键鱼灵升星", value: "batchFishSpiritUpgrade" },
  { label: "一键图鉴升星", value: "batchBookUpgrade" },
  { label: "一键领取图鉴奖励", value: "batchClaimStarRewards" },
  { label: "领取邮件并已读", value: "batchMarkMailRead" },
  { label: "一键邮件删除", value: "batchDeleteReadMails" },
  ...
  { label: "一键领取珍宝阁", value: "collection_claimfreereward" },
  { label: "一键领取单周福利", value: "activity_claimweeklyfree" },
  { label: "批量功法残卷领取", value: "batchLegacyClaim" },
  { label: "批量功法残卷赠送", value: "batchLegacyGiftSendEnhanced" },
  { label: "一键怪异塔道具合成", value: "batchWeirdTowerItemMerge" },
  { label: "一键领取蟠桃园任务", value: "batchClaimPeachTasks" },
  { label: "一键灯神扫荡", value: "batchGenieSweep" },
